...
import flinkCourse.entities.OrderItem;
import flinkCourse.entities.Product;
...
public class DataBatchJob {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource<OrderItem> orderItems = env
				.readCsvFile("C:\\Users\\seetha\\Flink\\Flink-Exercise\\SalesAnalysis\\Datasets\\order_items.csv")
				.ignoreFirstLine()
				.pojoType(OrderItem.class, "orderItemId", "orderId", "productId", "quantity", "pricePerUnit");

		DataSource<Product> products = env
				.readCsvFile("C:\\Users\\seetha\\Flink\\Flink-Exercise\\SalesAnalysis\\Datasets\\products.csv")
				.ignoreFirstLine()
